      ...
      <div className="relative z-10 max-w-7xl mx-auto px-6 pt-12">
        ...
        >
          <div className="flex items-center gap-3">
            <div className="flex items-center justify-center w-11 h-11 rounded-xl bg-teal-600 shadow-md shadow-teal-400/30">
              {" "}
            ...
            <div>
              ...
              <p className="text-xs text-slate-500 dark:text-slate-400">
                {temas.length}{" "}
                {temas.length === 1 ? "tema encontrado" : "temas encontrados"}
              </p>
            </div>
          </div>

          <Link to="/cadastrartema">
            <button className="group flex items-center gap-2 px-5 py-2.5 rounded-xl font-semibold text-sm text-white bg-teal-600 shadow-md shadow-teal-300/30 hover:bg-teal-500 hover:shadow-lg hover:shadow-teal-400/40 hover:-translate-y-0.5 hover:scale-[1.03] active:scale-95 transition-all duration-300 cursor-pointer">
              <RiAddCircleLine
                size={17}
        ...
        {!isLoading && temas.length === 0 && (
          ...
          >
            <div className="flex items-center justify-center w-20 h-20 rounded-2xl bg-teal-50 dark:bg-teal-900/20 border border-teal-100 dark:border-teal-800/40">
              <RiPriceTag3Line
                size={36}
                className="text-teal-300 dark:text-teal-600"
              />
            </div>
            <div>
            ...
            <Link to="/cadastrartema">
              <button className="group flex items-center gap-2 px-6 py-3 rounded-xl font-semibold text-sm text-white bg-teal-600 shadow-md shadow-teal-300/30 hover:bg-teal-500 hover:shadow-lg hover:-translate-y-0.5 active:scale-95 transition-all duration-300 cursor-pointer">
                {" "}
                <RiAddCircleLine
                  size={17}
                  className="group-hover:rotate-90 transition-transform duration-300"
